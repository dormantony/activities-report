...
function generarReporte(NUMSEMANA){
  ...
  rangosemana=sheettemas.getRange(1, inicio, sheettemas.getLastRow(), numIII);
  temp.getRange(1, 2, numRows,numIII).setValues(rangosemana.getValues())
  console.log(numIII)
